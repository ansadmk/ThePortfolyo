...
import { about, email } from "../../Redux/selectors";
                ...
                <ul>
                  {aboutData.address?<li>
                    <div className="list_inner">
                      ...
                      <a href={`http://maps.google.com/?q=${aboutData.address}`} style={{textDecoration:"none"}}><span >{aboutData.address}</span></a>
                    </div>
                  </li>:null}
                  {aboutData.phoneNumber?<li>
                    <div className="list_inner">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        version="1.1"
                      ...
                      <a href={`tel:${aboutData.phoneNumber?.replace('-','')}`} style={{textDecoration:"none"}}><span>{aboutData.phoneNumber}</span></a>
                    </div>
                  </li>:null}
                  {mail ? <li>
                    <div className="list_inner">
                      ...
                      <a href={`mailto:${mail}`} style={{textDecoration:"none"}}><span>{mail}</span></a>
                    </div>
                  </li>:null}
                  {/* <li>
                    <div className="list_inner">
